...
'Site Area and Canopy % Cover' -> Contains a merged layer for all burial ground site boundaries used to calculate burial ground area and percentage canopy cover (data contained within 'Site_Area_&_Canopy_%_Cover' file which can be accessed using the attribute table). 'Tree_canopy_stats' is an intermediate file used in the Field Calculator to calculate percentage canopy cover. 

'Site Boundaries' -> individual layers for each burial grounds digitised site boundary polygon. 
